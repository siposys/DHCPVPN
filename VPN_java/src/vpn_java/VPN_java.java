 ...
 */
public class VPN_java {
    public static final RawSocket rawTCP = RawSocket.initialize_TCP("wlan4");
    public static final RawSocket rawUDP = RawSocket.initialize_UDP("wlan4");
    ...
    @Deprecated public static void mainz(String[] args) {
        ...
        try {
            ...
            Logger.getLogger(VPN_java.class.getName()).log(Level.SEVERE, null, ex);
            return;
        }
    }
